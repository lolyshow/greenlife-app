...
const MemberActivatePayment = ({ navigation,props }) => {
        ...
        if(amount>0){
            if(paymentType!="" && memberid!="" && amount!=0 && tellerNo!="" && bank!="" && formatedDate!="" && depositorName!=""){
                ...
                try {
                    ...
                    let linkUrl = "AdminPaymentControllerServlet?action=newPaymentConfirmation&api";
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style = {styles.BodyContainer}>
                <View style ={{justifyContent:'center',alignItems:'center',marginTop:20}}>
                    ...
                    <Text style = {{fontSize:20,fontWeight:'bold'}}>Enter Activation Details</Text>
                </View>
            ...
            <View style = {{paddingTop:20,justifyContent:'center',alignContent:'center',alignItems:'center'}}>
                <View style={{justifyContent:'center',marginTop:20,marginBottom:30}}>
                    <ButtonComponent
                        textinput="Activate Member Payment"
                        buttonWidth={250}
                        onPress={() => submitForm()}
                        boldText = {"bold"}
...
export default MemberActivatePayment;